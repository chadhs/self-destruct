...
*** Set Environment Variables & Secrets
    ...
    ~.env~ is gitignored. Use ~./scripts/with-env.sh ...~ to load it before
    ~clj~ commands, or export the variables in your shell. The example includes:
...
*** Setup Local Development Database
    ...
    #+BEGIN_SRC sh
      ...
      ./scripts/with-env.sh clj -M:migrate
    #+END_SRC
...
*** Run the app
    ...
    #+BEGIN_SRC sh
      ./scripts/with-env.sh clj -M:dev-main
    #+END_SRC
    ...
    #+BEGIN_SRC sh
      ./scripts/with-env.sh clj -M:css watch
      ./scripts/with-env.sh clj -M:run -- --port 8000
    #+END_SRC
...
** Database Migrations
   ...
   - Apply migrations with ~./scripts/with-env.sh clj -M:migrate~ or
